document.addEventListener('DOMContentLoaded', function() {
    ...
    const originalGenerateText = generateBtn.querySelector('.select-btn-text').textContent;
    ...
    uploadBtn.addEventListener('click', function() {
        const isActive = uploadBtn.classList.toggle('active');
        ...
        if (isActive) {
            ...
            generateBtn.querySelector('.select-btn-text').textContent = 'Генерировать - 2';
            generateBtn.querySelector('.select-btn-img svg').style.transform = 'scale(1.2)';
        } else {
            ...
            generateBtn.querySelector('.select-btn-text').textContent = originalGenerateText;
            generateBtn.querySelector('.select-btn-img svg').style.transform = 'scale(1)';
        }
